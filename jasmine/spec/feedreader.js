...
$(function() {
	...
	describe('RSS Feeds', function() {
		 ...
		 */
		it('has feed items, each with a URL and the URL is not empty', () => {
		 ...
		 */
		it('has feed items, each with a name and not an empty name', () => {
			allFeeds.forEach(feed => {
	...
	describe('The menu', () => {
		 ...
		 */
		it('changes its visibility state when the menu icon is clicked', () => {
	...
	describe('New Feed Selection', () => {
		...
		it('changes the feed content when a new feed is loaded', () => {
